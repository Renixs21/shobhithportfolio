...
/**
 * A living skill constellation. Nodes are clustered by group in rings,
 * drift on a gentle physics simulation, and brighten under the cursor —
 * which also lights up their direct connections. Logos render inside
 * circular badges; hover reveals the name, click opens the official page.
 */
  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-7xl px-6 md:px-10">
        {/* Section heading — "A constellation, not a checklist." */}
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Not a list of bars — a living network of the tools I reach
              for. Hover any logo to see its name and connections; click to
        ...
        {/* The graph canvas — clustered group rings */}
        <div
          ref={wrapRef}
          className="relative aspect-[16/10] w-full overflow-hidden rounded-3xl border border-hairline bg-obsidian/40 md:aspect-[16/9]"
        >
          <canvas
            ref={canvasRef}
            tabIndex={0}
          ...
          />
          {/* Hover readout */}
          <div className="pointer-events-none absolute left-4 top-4 flex items-center gap-2 rounded-full border border-hairline bg-obsidian/70 px-3 py-1.5 backdrop-blur">
